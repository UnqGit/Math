...
class continuous_derivatives {
  ...
  public:
    ...
    continuous_derivatives(bool a = false): LoadThrow(a) {}
  ...
  private:
    ...
    void make_map() {
        unary_funcs["exp"] = std::bind(&continuous_derivatives::exp_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["ln"] = std::bind(&continuous_derivatives::ln_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["sin"] = std::bind(&continuous_derivatives::sin_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["cos"] = std::bind(&continuous_derivatives::cos_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["csc"] = std::bind(&continuous_derivatives::csc_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["sec"] = std::bind(&continuous_derivatives::sec_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["tan"] = std::bind(&continuous_derivatives::tan_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["cot"] = std::bind(&continuous_derivatives::cot_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["asin"] = std::bind(&continuous_derivatives::asin_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["acos"] = std::bind(&continuous_derivatives::acos_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["acsc"] = std::bind(&continuous_derivatives::acsc_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["asec"] = std::bind(&continuous_derivatives::asec_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["atan"] = std::bind(&continuous_derivatives::atan_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["acot"] = std::bind(&continuous_derivatives::acot_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["sinh"] = std::bind(&continuous_derivatives::sinh_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["cosh"] = std::bind(&continuous_derivatives::cosh_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["csch"] = std::bind(&continuous_derivatives::csch_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["sech"] = std::bind(&continuous_derivatives::sech_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["tanh"] = std::bind(&continuous_derivatives::tanh_derivatives, this, std::placeholders::_1, std::placeholders::_2);
        unary_funcs["coth"] = std::bind(&continuous_derivatives::coth_derivatives, this, std::placeholders::_1, std::placeholders::_2);

        binary_funcs["pow"] = std::bind(&continuous_derivatives::pow_derivatives, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
        binary_funcs["add"] = std::bind(&continuous_derivatives::add_derivatives, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
        binary_funcs["sub"] = std::bind(&continuous_derivatives::sub_derivatives, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
        binary_funcs["mul"] = std::bind(&continuous_derivatives::mul_derivatives, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
        binary_funcs["div"] = std::bind(&continuous_derivatives::div_derivatives, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    }
